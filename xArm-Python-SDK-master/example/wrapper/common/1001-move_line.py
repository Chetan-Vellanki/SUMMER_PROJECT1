...
arm.set_position(x=300, y=200, z=250, roll=-180, pitch=0, yaw=0, speed=10, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=500, y=200, z=150, roll=-180, pitch=0, yaw=0, speed=10, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=500, y=-200, z=250, roll=-180, pitch=0, yaw=0, speed=10, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=300, y=-200, z=150, roll=-180, pitch=0, yaw=0, speed=10, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=300, y=0, z=250, roll=-180, pitch=0, yaw=0, speed=10, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
