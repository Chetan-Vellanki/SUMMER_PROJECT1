...
def main() -> None:
    ...
    while True : 
        ...
        print("JAC : ", jac)
        jac1 = jac[:, :7]
        current_cartesian_velocities = np.array(jac1) @ (1000 * np.array(current_joint_velocities))
        print("Current cartesian velocity of end eff : ", current_cartesian_velocities)
        target_velocity = Kp * 1000 * error + Kd * (desired_velocity  - current_cartesian_velocities[: 3])
